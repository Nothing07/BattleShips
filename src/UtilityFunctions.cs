...
{
	//Creates the variables and constants and stores their allocated variables
	...
	{
		DrawCustomField(grid, thePlayer, false, showShips, FIELD_LEFT, FIELD_TOP, FIELD_WIDTH, FIELD_HEIGHT, CELL_WIDTH, UtilityFunctions.CELL_HEIGHT,
		CELL_GAP);
	}
	...
	//Creates a new instance of the List<Sprite>
	...
	private static void AddAnimation(int row, int col, string image)
	{
		...
		s.Y = FIELD_TOP + row * (UtilityFunctions.CELL_HEIGHT + CELL_GAP);
